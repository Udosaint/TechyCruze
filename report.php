	    ...
	    <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
	      ...
	      <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            <a class="nav-link d-flex align-items-center gap-2" href="sendngn">
	          ...
	          <li class="nav-item">
	            <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="report">
  	...
  	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <table class="table  table-md  caption-top">
          ...
          <?php $i = 1; while ($row = $chekPwd->fetch(PDO::FETCH_ASSOC)):?>
              ...
              <td><?= $row['status'] ?></td>
              <td>
              	<button id='refresh<?= $row['request_id'] ?>' data="<?= $row['request_id'] ?>" class="btn btn-secondary">
