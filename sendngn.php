...
require 'header.php';
 ...
 <title><?= SITE  ?> Send SMS Nigeria</title>
	    ...
	    <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
	      ...
	      <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
	        ...
	        <ul class="nav nav-pills flex-column mb-auto px-3">
	          ...
	          <li class="nav-item mb-1">
	            <a class="nav-link d-flex align-items-center gap-2 " aria-current="page"  href="sms">
	        ...
	        <li class="nav-item mb-1">
	            <a class="nav-link d-flex align-items-center active gap-2" href="sendngn">
	...
	<!-- SIDEBAR END -->
  	...
  	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
	        <h1 class="h2">Send SMS Nigeria </h1>
	    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data == "success") {
                    ...
                    setTimeout(' window.location.href = "sendngn"; ', 3000);
                }else{
